...
/**
 * Contains methods signatures needed for creating a Yeti
 *
 * @author csd4988
 * @version 1.0
 */
public class Yeti extends Piece {
    /**
     * Constructor
     * <b>Postcondition:</b> Creates a new Yeti with the given player and position
     */
    public Yeti(int player, int position) {
