...
/**
 * Contains methods signatures needed for creating a Slayer
 *
 * @author csd4988
 * @version 1.0
 */
public class Slayer extends Piece {
    /**
     * Constructor
     * <b>Postcondition:</b> Creates a new Slayer with the given player and position
     */
    public Slayer(int player, int position) {
