...
/**
 * Contains methods signatures needed for creating a Knight
 *
 * @author csd4988
 * @version 1.0
 */
public class LavaBeast extends Piece {
    /**
     * Constructor
     * <b>Postcondition:</b> Creates a new Knight with the given player and position
     */
    public LavaBeast(int player, int position) {
        super(5, player, position);
    }
