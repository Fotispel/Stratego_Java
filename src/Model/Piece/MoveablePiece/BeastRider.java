...
/**
 * Contains methods signatures needed for creating a BeastRider
 *
 * @author csd4988
 * @version 1.0
 */
public class BeastRider extends Piece {
    /**
     * Constructor
     * <b>Postcondition:</b> Creates a new BeastRider with the given player and position
     */
    public BeastRider(int player, int position) {
        super(7, player, position);
    }
