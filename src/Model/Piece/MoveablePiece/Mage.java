...
/**
 * Contains methods signatures needed for creating a Mage
 *
 * @author csd4988
 * @version 1.0
 */
public class Mage extends Piece {
    /**
     * Constructor
     * <b>Postcondition:</b> Creates a new Mage with the given player and position
     */
    public Mage(int player, int position) {
        super(9, player, position);
    }
