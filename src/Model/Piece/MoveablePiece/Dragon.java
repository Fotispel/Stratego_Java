...
/**
 * Contains the basic methods signatures needed for creating a Dragon
 *
 * @author csd4988
 * @version 1.0
 */
public class Dragon extends Piece {
    ...
    /**
     * Constructor
     * <b>Postcondition:</b> Creates a new Dragon with the given player and position
     *
     */
    public Dragon(int player, int position) {
