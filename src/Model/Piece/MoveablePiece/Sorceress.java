...
/**
 * Contains methods signatures needed for creating a Sorceress
 *
 * @author csd4988
 * @version 1.0
 */
public class Sorceress extends Piece {
    /**
     * Constructor
     * <b>Postcondition:</b> Creates a new Sorceress with the given player and position
     */
    public Sorceress(int player, int position) {
        super(6, player, position);
    }
