...
/**
 * Contains methods signatures needed for creating an Elf
 *
 * @author csd4988
 * @version 1.0
 */
public class Elf extends Piece {
    /**
     * Constructor
     * <b>Postcondition:</b> Creates a new Elf with the given player and position
     */
    public Elf(int player, int position) {
        super(4, player, position);
    }
